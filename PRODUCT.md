...
5. **Nutrition depth.** A real food database behind the existing catalog, barcode entry, and macronutrient targets derived from the goal and energy calculations already shipped. Goal-derived macro targets are now shipped ([Specification 0047](specs/0047-goal-derived-macro-targets.md)); the food database and barcode entry remain unapproved after FoodData Central's internal completeness proved promising but representative real-world discovery remained unmeasured ([ADR 0036](docs/decisions/0036-fooddata-central-coverage-remains-unproven.md)). The initial nutrition launch market (United States) and independent sampling frames were defined and approved in Sprint 51 ([ADR 0037](docs/decisions/0037-initial-nutrition-market-and-independent-sampling-frame.md)).
