...
5. **Nutrition depth.** A real food database behind the existing catalog, barcode entry, and macronutrient targets derived from the goal and energy calculations already shipped. Goal-derived macro targets are now shipped ([Specification 0047](specs/0047-goal-derived-macro-targets.md)); the food database and barcode entry remain unapproved.
