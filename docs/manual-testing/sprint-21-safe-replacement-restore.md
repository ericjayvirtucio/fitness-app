...
| Data controls reach | With the largest practical text size, open Data controls and reach every one of the four actions by scrolling. Report if the destructive ones are hard to reach or if any label truncates. |
