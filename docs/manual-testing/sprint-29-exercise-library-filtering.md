...
| Controls appear   | Add the starter exercises, then look above the starter section.                  | Both filters appear beside the search field, each showing "Any equipment" or "Any muscle group" as the selected choice.                                  |
